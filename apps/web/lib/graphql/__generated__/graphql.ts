...
export type MyPlanQuery = { myEntitlements: { plan: string, audience: string, maxTemplates: number | null, maxMesocycles: number | null, maxWorkouts: number | null, ai: boolean, planSessions: boolean, maxAthletes: number | null }, mySubscription: { id: string, planSlug: string, planName: string, gateway: string, status: string, amountCents: number | null, currency: string | null, interval: string | null, currentPeriodEnd: string, cancelAtPeriodEnd: boolean, pendingPlanSlug: string | null, canResume: boolean } | null };
