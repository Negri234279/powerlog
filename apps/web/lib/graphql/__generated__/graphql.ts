...
export type MyAthletesQuery = { myAthletes: Array<{ userId: string, username: string, avatarUrl: string | null }> };

export type MyCoachesQueryVariables = Exact<{ [key: string]: never; }>;


export type MyCoachesQuery = { myCoaches: Array<{ userId: string, username: string, avatarUrl: string | null }> };
