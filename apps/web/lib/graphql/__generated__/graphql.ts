...
export type MyInvoicesQuery = { myInvoices: { total: number, rows: Array<{ id: string, number: string | null, status: string, amountPaidCents: number, amountDueCents: number, currency: string, hostedUrl: string | null, pdfUrl: string | null, receiptUrl: string | null, issuedAt: string }> } };
