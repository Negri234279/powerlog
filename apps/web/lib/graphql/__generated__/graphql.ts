...
export type MyAthleteRosterQuery = { myAthleteRoster: Array<{ athleteId: string, coachedSince: string, lastSessionAt: string | null, daysSinceLastSession: number | null, nextSessionAt: string | null, adherenceRate: number | null, plannedCompleted: number, plannedMissed: number, plannedDue: number, completedSessions: number, volumeKg: number | null, volumeChange: number | null, attention: RosterAttention }> };
