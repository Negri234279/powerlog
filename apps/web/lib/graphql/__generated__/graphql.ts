...
export type AvailablePlansQuery = { availablePlans: Array<{ id: string, slug: string, name: string, description: string | null, isFree: boolean, sortOrder: number, templates: boolean, mesocycles: boolean, ai: boolean, planSessions: boolean, maxAthletes: number | null, prices: Array<{ id: string, interval: string, currency: string, amountCents: number, gateways: Array<string> }>, offer: { id: string, name: string, trialDays: number | null, endsAt: string | null, introPhase: { cycles: number, percentOff: number } | null } | null }> };

export type MyPlanQueryVariables = Exact<{ [key: string]: never; }>;


export type MyPlanQuery = { myEntitlements: { plan: string, audience: string, templates: boolean, mesocycles: boolean, ai: boolean, planSessions: boolean, maxAthletes: number | null }, mySubscription: { id: string, planSlug: string, planName: string, gateway: string, status: string, amountCents: number | null, currency: string | null, interval: string | null, currentPeriodEnd: string, cancelAtPeriodEnd: boolean, pendingPlanSlug: string | null } | null };
...
export type MyInvoicesQuery = { myInvoices: { total: number, rows: Array<{ id: string, number: string | null, status: string, amountPaidCents: number, amountDueCents: number, currency: string, hostedUrl: string | null, pdfUrl: string | null, issuedAt: string }> } };
...
export type ChangePlanMutation = { changePlan: boolean };
...
export type AdminPlansQuery = { adminPlans: Array<{ id: string, audience: string, slug: string, name: string, description: string | null, status: string, isFree: boolean, sortOrder: number, entitlements: unknown, snapshot: { templates: boolean, mesocycles: boolean, ai: boolean, planSessions: boolean, maxAthletes: number | null }, prices: Array<{ id: string, interval: string, currency: string, amountCents: number, active: boolean, stripePriceId: string | null, paypalPlanId: string | null }> }> };
