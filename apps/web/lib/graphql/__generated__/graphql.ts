...
export type SessionPlanDraftQuery = { sessionPlanDraft: { id: string, sessionId: string, provider: string, model: string, status: string, updatedAt: string, sets: Array<{ setId: string, plannedWeightKg: number | null, plannedReps: number | null, rpe: number | null, rir: number | null, notes: string | null }>, messages: Array<{ id: string, role: string, content: string, createdAt: string }> } | null };
...
export type GenerateSessionPlanDraftMutation = { generateSessionPlanDraft: { id: string, sessionId: string, provider: string, model: string, status: string, updatedAt: string, sets: Array<{ setId: string, plannedWeightKg: number | null, plannedReps: number | null, rpe: number | null, rir: number | null, notes: string | null }>, messages: Array<{ id: string, role: string, content: string, createdAt: string }> } };
...
export type RefinePlanDraftMutation = { refinePlanDraft: { id: string, sessionId: string, provider: string, model: string, status: string, updatedAt: string, sets: Array<{ setId: string, plannedWeightKg: number | null, plannedReps: number | null, rpe: number | null, rir: number | null, notes: string | null }>, messages: Array<{ id: string, role: string, content: string, createdAt: string }> } };
...
export const GenerateSessionPlanDraftDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"GenerateSessionPlanDraft"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"sessionId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"generateSessionPlanDraft"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"sessionId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"sessionId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"AiPlanDraftFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AiPlanDraftFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"AiPlanDraft"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"sessionId"}},{"kind":"Field","name":{"kind":"Name","value":"provider"}},{"kind":"Field","name":{"kind":"Name","value":"model"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"sets"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"setId"}},{"kind":"Field","name":{"kind":"Name","value":"plannedWeightKg"}},{"kind":"Field","name":{"kind":"Name","value":"plannedReps"}},{"kind":"Field","name":{"kind":"Name","value":"rpe"}},{"kind":"Field","name":{"kind":"Name","value":"rir"}},{"kind":"Field","name":{"kind":"Name","value":"notes"}}]}},{"kind":"Field","name":{"kind":"Name","value":"messages"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"role"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]} as unknown as DocumentNode<GenerateSessionPlanDraftMutation, GenerateSessionPlanDraftMutationVariables>;
