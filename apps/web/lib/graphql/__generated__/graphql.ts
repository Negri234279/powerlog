...
export type GenerateMesocycleDraftMutation = { generateMesocycleDraft: { id: string, athleteId: string | null, provider: string, model: string, status: string, weeks: number, trainingDays: Array<number>, goal: string | null, name: string, parentDraftId: string | null, mesocycleId: string | null, createdAt: string, updatedAt: string, days: Array<{ dayOffset: number, label: string | null, exercises: Array<{ exerciseId: string, slug: string, name: string, notes: string | null, sets: Array<{ order: number, plannedWeightKg: number | null, plannedReps: number | null, rpe: number | null, rir: number | null, notes: string | null }> }> }>, messages: Array<{ id: string, role: string, content: string, createdAt: string }> } };
...
export type RefineMesocycleDraftMutation = { refineMesocycleDraft: { id: string, athleteId: string | null, provider: string, model: string, status: string, weeks: number, trainingDays: Array<number>, goal: string | null, name: string, parentDraftId: string | null, mesocycleId: string | null, createdAt: string, updatedAt: string, days: Array<{ dayOffset: number, label: string | null, exercises: Array<{ exerciseId: string, slug: string, name: string, notes: string | null, sets: Array<{ order: number, plannedWeightKg: number | null, plannedReps: number | null, rpe: number | null, rir: number | null, notes: string | null }> }> }>, messages: Array<{ id: string, role: string, content: string, createdAt: string }> } };
...
export type GenerateSessionPlanDraftMutation = { generateSessionPlanDraft: { id: string, sessionId: string, entryId: string | null, provider: string, model: string, status: string, parentDraftId: string | null, createdAt: string, updatedAt: string, sets: Array<{ entryId: string, order: number, plannedWeightKg: number | null, plannedReps: number | null, rpe: number | null, rir: number | null, notes: string | null }>, messages: Array<{ id: string, role: string, content: string, createdAt: string }> } };
...
export type RefinePlanDraftMutation = { refinePlanDraft: { id: string, sessionId: string, entryId: string | null, provider: string, model: string, status: string, parentDraftId: string | null, createdAt: string, updatedAt: string, sets: Array<{ entryId: string, order: number, plannedWeightKg: number | null, plannedReps: number | null, rpe: number | null, rir: number | null, notes: string | null }>, messages: Array<{ id: string, role: string, content: string, createdAt: string }> } };
