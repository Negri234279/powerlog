...
export class ExerciseHistorySetType {
    @Field(() => FloatRangeType, { nullable: true, description: 'Programmed target weight (kg), if any.' })
    plannedWeightKg?: FloatRangeType | null

    @Field(() => IntRangeType, { nullable: true, description: 'Programmed target reps, if any.' })
