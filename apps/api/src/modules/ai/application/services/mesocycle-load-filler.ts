...
import type { DraftMesocycleDay } from '../../domain/entities/ai-mesocycle-draft.entity'
 ...
 * be asked to do in prose (IA.5). Runs after the parser, on the template week,
 * before the block is expanded into microcycles (IA.7).
 *
...
export function fillMesocycleLoads(
    days: readonly DraftMesocycleDay[],
